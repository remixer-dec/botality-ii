export default {
  ...
  llm_max_history_items: 'Сколько сообщений может храниться в истории с пользователем.',
  ...
  llm_assistant_use_in_chat_mode: 'Вместо формирования истории разговора с помощью ограниченного FIFO-массива, всегда использовать формат promptа, указанный в файле персонажа, для instruct-only моделей.',
  ...
  llm_max_tokens: 'Макс. новых токенов в режиме чата (с историей).',
  ...
  mm_management_policy: 'В режиме COUNT, после того как количество моделей в памяти будет больше лимита, произойдёт выгрузка модели, в режиме MEMORY, когда почти нет свободной памяти, модель будет выгружена (но невозможно оценить расход памяти для новой загружаемой модели).',
